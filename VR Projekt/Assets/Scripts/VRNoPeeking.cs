...
public class VRNoPeeking : MonoBehaviour
{
    ...
    [SerializeField] float shpereCheckSize = 0.15f;
    ...
    void Update()
    {
        if(Physics.CheckSphere(transform.position, shpereCheckSize, collisionLayer, QueryTriggerInteraction.Ignore))
        {
            CameraFade(1f);
    ...
    private void OnDrawGizmos()
    {
        ...
        Gizmos.DrawSphere(transform.position, shpereCheckSize);
    }
}
