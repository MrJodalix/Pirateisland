...
namespace Unity.VRTemplate
{
    ...
    public class XRKnob : XRBaseInteractable
    {
        ...
        [SerializeField]
        [Tooltip("If the Object is a Dial it is going to test the rotation")]
        Dial m_Dial = null;

        [SerializeField]
        [Tooltip("If the Object is a wheel for marbleRun it is going to test the value")]
        MarbleRun m_MarbleRun = null;
        ...
        void StartGrab(SelectEnterEventArgs args)
        {
            ...
            currentKnobRotation = m_BaseKnobRotation;
            UpdateRotation(true);
        }
        ...
        void UpdateRotation(bool freshCheck = false)
        {
            ...
            var knobRotation = currentKnobRotation - ((m_UpVectorAngles.totalOffset + m_ForwardVectorAngles.totalOffset) * m_TwistSensitivity) - m_PositionAngles.totalOffset;
        ...
        void SetKnobRotation(float angle)
        {
            ...
            if (m_Dial != null)
                m_Dial.testAngle(angle);

            if (m_MarbleRun != null)
                m_MarbleRun.testValue(m_Value);
        }
